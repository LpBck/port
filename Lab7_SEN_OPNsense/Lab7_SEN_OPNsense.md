...
## Описание
Сеть разделена на четыре зоны: **WAN**, **DMZ**, **LAN**, **MGMT**. Центральный узел это OPNsense, выполняющий функции маршрутизатора, NAT, firewall и VPN-шлюза. Политика по умолчанию deny-all, трафик разрешается явными правилами. Картинка вдохновлена мемом с Wojack-ами
